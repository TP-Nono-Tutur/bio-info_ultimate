...
val list : int -> Fasta.fasta -> K_mer.t list

(** Comme [list] mais utilise une window au lieu d'un fasta *)
val list_of_window : int -> Window.t -> K_mer.t list
...
val list_spaced : string -> Fasta.t -> K_mer.t list

(** Comme [list_spaced] mais utilise une window au lieu d'un fasta *)
val list_spaced_of_window : string -> Window.t -> K_mer.t list
...
val common : K_mer.t list -> K_mer.t list -> K_mer.t list

val list_spaced_multiple : string -> Fasta.t -> (string * K_mer.t list) list 
